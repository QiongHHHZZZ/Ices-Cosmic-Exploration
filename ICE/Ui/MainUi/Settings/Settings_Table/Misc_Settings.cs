...
namespace ICE.Ui.MainUi.Settings.Settings_Table
{
    internal class Misc_Settings
    {
        ...
        private static void RepairSettings()
        {
            ...
            if (ImGui.Checkbox(T("Stop when below x dark matter"), ref stopWhenNoDarkMatter))
            {
            ...
            if (ImGui.InputInt(T("Minimum Grade 8 Dark Matter"), ref minDarkMatter, 1, 10))
            {
                C.Minimum_DarkMatter = minDarkMatter;
                C.SaveDebounced();
            }
            PlayerHelper.GetItemCount(Utils.DarkMatter_8Id, out var dmCount);
            ImGui.Text(T("Current have: {0:N0} Grade 8 Dark Matter", dmCount));
        }
