        ...
        public static void Draw()
        {
            ...
            using (var headerChild = ImRaii.Child("##modeSelect_StandardHeader", new Vector2(0, 45 * scale), true, ImGuiWindowFlags.NoScrollbar))
            {
                ...
                if (ImGui.BeginPopup("Mode Select | Select Mode Window"))
                {
                    ...
                    ImGuiEx.HelpMarker(T("Gold Completion Mode\n" +
                    ...
                    ImGuiEx.HelpMarker(
                        T("This mode is if you want to do a series of things in a particular order. So for example, if you wanted to grind out all the relics on all the classes back to back\n" +
                ...
                if (showNextColumn)
                {
                    ...
                    if (C.TurninRelic)
                    {
                        ...
                        if (showJobSwapExpanded)
                        {
                            ...
                            if (ImGui.BeginCombo(T("Battle Job"), T(currentJobName)))
                            {
